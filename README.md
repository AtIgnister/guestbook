...
~~ Have a look at both this blogpost https://anarchaeopteryx.bearblog.dev/2025-12-24-trusting-the-little-guy-me/ and https://avas.bearblog.dev/alternatives-trust/, and add everything there that we can implement to the TODO list  ~~ Done!
...
~~ change all regular IDs we use to UUIDs, and store them as ints~~ Done!
...
~~ fix or update all currently failing tests. Currently I'm not sure which of these are because of actual bugs, and which are just because I've refactored some parts to be different to the default laravel template this started out as ~~ Done!
