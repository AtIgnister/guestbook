...
<ol>
    ...
    <li>
        ...
        <p>Your session data includes your IP, your user id (if you have an account and are currently logged in),
            your browsers user agent, and the last time you interacted with the website.</p>
...
<ol>
    <li><strong>Access:</strong> Request a copy of your data. You can do this from the dashboard by pressing the
        "download complete user data backup" button. TODO: implement this</li>
...
<p>I take reasonable measures to keep this website secure, but no system is perfect. Use a strong password and
    practice online safety. I strongly discourage you from posting any personably identifiable information in the
