...
<section class="entry-container m-3">
    ...
    @if ($guestbook->requires_approval)
        <p class="text-red-400 approval-warning">Approval only mode: After you've submitted your entry, it won't be immediately visible. You will have to wait a bit for the owner of this guestbook to manually approve it.</p>
    @endif
