    ...
    @if (Route::has('login'))
        <nav class="flex items-center justify-end gap-4">
            @auth
                <a
                    href="{{ url('/dashboard') }}"
                    class="inline-block px-5 py-1.5 rounded-sm leading-normal"
                >
                    Dashboard
                </a>
            @else
        ...
        <main class="max-w-2xl mx-auto">
            ...
            <br><br>
            <p>Not quite sure how to set up your guestbook?</p>
            <a href="/blog/tutorial">Follow the setup tutorial!</a>
